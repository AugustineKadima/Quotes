...
export class QuotesService {
  ...
  getQuotes(){
    return [
      new QuoteModel(1, "Everyone thinks of changing the world, but no one thinks of changing himself", " Leo Tolstoy", "Augustine", new Date(1/2/2023)),
      new QuoteModel(2, "Never doubt that a small group of thoughtful, committed, citizens can change the world", "Margaret Mead", "Anira", new Date(2/4/2022)),
